'''2) Представлен список чисел. Необходимо вывести элементы исходного списка,  элемента.
значения которых больше предыдущего Подсказка: элементы, удовлетворяющие условию,
